...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@adapterly.ai")
...
APP_TAGLINE = os.getenv("APP_TAGLINE", "Agent-friendly integrations for every system")
APP_PRIMARY_COLOR = os.getenv("APP_PRIMARY_COLOR", "#6366f1")
APP_SECONDARY_COLOR = os.getenv("APP_SECONDARY_COLOR", "#8b5cf6")
